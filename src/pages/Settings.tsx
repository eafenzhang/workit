                ...
                return (
                  <button
                    ...
                    style={{
                      ...
                      border: isActive ? '2px solid var(--wiki-accent)' : '1px solid var(--wiki-border)',
                    }}
                  >
                    <div className="w-10 h-10 rounded-md flex items-center justify-center" style={{ background: 'var(--wiki-bg)', border: '1px solid var(--wiki-border)' }}>
                      <Icon size={18} style={{ color: 'var(--wiki-text)' }} />
                    </div>
                    <div className="text-sm font-medium" style={{ color: 'var(--wiki-text)' }}>{opt.label}</div>
          ...
          <div className="rounded-lg p-5" style={{ background: 'var(--wiki-surface)', border: '1px solid var(--wiki-border)' }}>
            <div className="flex items-center justify-between">
              ...
              <button
                ...
                style={{ background: quickCollect ? '#6366f1' : 'rgba(99,112,196,0.2)' }}
              >
                <span
                  className="absolute top-0.5 w-5 h-5 rounded-full bg-white shadow transition-all"
                  style={{ left: quickCollect ? '26px' : '4px', transition: 'left 0.2s' }}
                />
              </button>
            </div>
          </div>
